...
@Component({
  ...
  template: `
    <label class="flex items-start space-x-3 cursor-pointer group">
      ...
      <div
        class="w-5 h-5 mt-0.5 shrink-0 rounded-md border-2 flex items-center justify-center transition-all duration-200 ease-in-out
      ...
      <span class="text-gray-700 dark:text-gray-200 leading-relaxed select-none">
        {{label}}
      </span>
    </label>
  `,
